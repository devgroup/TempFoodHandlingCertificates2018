...
namespace TempFoodHandlingCertificates2014.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private Helpers.MyUserManager _userManager;
        public AccountController() : this(new Helpers.MyUserManager()) { }
        ...
        //public ApplicationUserManager UserManager {
         public Helpers.MyUserManager UserManager {
            get
            {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                ////Start of code changes by tom to send password reset
                 ...
                 // mailMessage.From = new MailAddress("zz@hobartcity.com.au");
                 mailMessage.To.Add(new MailAddress("wasst@hobartcity.com.au"));
